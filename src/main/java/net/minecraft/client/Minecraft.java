...
public abstract class Minecraft implements Runnable {
    ...
    private static final List<DisplayMode> MAC_DISPLAY_MODES = new ArrayList<>();
    static
    {
        MAC_DISPLAY_MODES.add(new DisplayMode(2560, 1600));
        MAC_DISPLAY_MODES.add(new DisplayMode(2880, 1800));
    }
	...
	public void startGame() throws LWJGLException {
        // had to remove AWT canvas bullshit, made colors go haywire on macos (m5 pro chip)
        if (fullscreen)
        {
...
//					}
    ...
    private void updateDisplay() throws LWJGLException
    {
        Display.update();
    ...
    private void updateDisplayMode() throws LWJGLException
    {
        ...
        if (!var1.contains(var2) && System.getProperty("os.name").toLowerCase().contains("mac"))
        {
