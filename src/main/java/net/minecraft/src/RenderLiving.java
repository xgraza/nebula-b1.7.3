...
public class RenderLiving<T extends EntityLiving> extends Render<T> {
	...
	protected void func_22012_b(T var1, double var2, double var4, double var6) {
	...
	protected float func_170_d(T var1, float var2) {
	...
	protected boolean func_27005_b(T var1, int var2, float var3) {
		return this.shouldRenderPass(var1, var2, var3);
	}

	protected boolean shouldRenderPass(T var1, int var2, float var3) {
		return false;
	}
	...
	protected void passSpecialRender(T var1, double var2, double var4, double var6) {
